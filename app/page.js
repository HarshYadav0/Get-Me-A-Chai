  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <div className="flex justify-center flex-col gap-5 items-center text-white h-fit mt-3 mb-5 px-5 md:px-0 ">
           
            <div className="font-bold flex gap-5 md:gap-5 justify-center items-center md:text-5xl text-4xl">
              Buy Me a Chai <span><img src="tea.gif" width="88" alt="" /></span>
            </div>
          ...
          <div className="text-white container mx-auto pb-32 pt-14 px-10">
            ...
            <div className="flex gap-5 justify-around">
              <div className="item space-y-3 flex flex-col items-center justify-center">
                <img src="man.gif" alt="" className="bg-slate-400 rounded-full p-1 text-black" width={88} />
                <p className="font-bold text-center">Fans want to help</p>
                <p className="text-center">Your Fans are available for you to help you</p>
              </div>
              <div className="item space-y-3 flex flex-col items-center justify-center">
                <img src="coin.gif" alt="" className="bg-slate-400 rounded-full p-1 text-black" width={88} />
                <p className="font-bold text-center">Fans want to help</p>
                <p className="text-center">Your Fans are available for you to help you</p>
              </div>
              <div className="item space-y-3 flex flex-col items-center justify-center">
                <img src="group.gif" alt="" className="bg-slate-400 rounded-full p-1 text-black" width={88} />
                <p className="font-bold text-center">Fans want to help</p>
                <p className="text-center">Your Fans are available for you to help you</p>
              </div>
            </div>
